::LOBO <-
{
	...
	is_sigmod = Convars.GetInt("sig_etc_misc") != null
	...
	InitialiseInsight = function()
	{
		...
		this.insight_id[GetPropString(player_array[lucky], "m_szNetworkIDString")] <- 1
	}
...
// precache stuff for safety, for servers that dont run rafmod.
// ie dont precache twice
if (!LOBO.is_sigmod) LOBO.PrecacheAssets()

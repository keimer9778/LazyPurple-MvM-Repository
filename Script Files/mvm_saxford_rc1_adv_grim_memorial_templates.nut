        ...
        Grimmemorial_Boss = {
                ...
                [1] = {
                        logic_relay = {
                                ...
                                "OnTrigger#9": "statue_stop,enable,,4.5,-1"
                                "OnTrigger#10": "statue_stop,disable,,4.6,-1"
                                "OnTrigger#11": "bigshake,startshake,,6.8,-1"
                                "OnTrigger#12": "statue_jump_for_joy,ApplyImpulse,,6.8,-1"
                        }
                },
                [2] = {
                    trigger_hurt = {
